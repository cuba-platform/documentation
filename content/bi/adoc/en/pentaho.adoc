...
+
--
* Download https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.2.4/cuba-bi-pentaho-1.2.4.jar[cuba-bi-pentaho-1.2.4.jar] and copy it to `$PENTAHO_HOME$/pentaho-server/tomcat/webapps/pentaho/WEB-INF/lib`.

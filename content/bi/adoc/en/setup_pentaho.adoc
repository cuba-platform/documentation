...
+
--
* Download https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.4.0/cuba-bi-pentaho-1.4.0.jar[cuba-bi-pentaho-1.4.0.jar] and copy it to `$PENTAHO_HOME$/pentaho-server/tomcat/webapps/pentaho/WEB-INF/lib`.

* Download https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.4.0/cuba-bi-pentaho-1.4.0-plugin.zip[cuba-bi-pentaho-1.4.0-plugin.zip], unpack it and copy the `saiku-cuba-bi` folder to `$PENTAHO_HOME/pentaho-server/pentaho-solutions/system`.

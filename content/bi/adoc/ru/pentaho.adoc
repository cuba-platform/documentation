...
+
--
* Скачайте https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.2.4/cuba-bi-pentaho-1.2.1.jar[cuba-bi-pentaho-1.2.1.jar] и скопируйте его в папку `$PENTAHO_HOME$/pentaho-server/tomcat/webapps/pentaho/WEB-INF/lib`.

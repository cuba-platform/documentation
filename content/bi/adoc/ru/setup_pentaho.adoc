...
+
--
* Скачайте https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.6.0/cuba-bi-pentaho-1.6.0.jar[cuba-bi-pentaho-1.6.0.jar] и скопируйте его в папку `$PENTAHO_HOME$/pentaho-server/tomcat/webapps/pentaho/WEB-INF/lib`.

* Скачайте https://dl.bintray.com/cuba-platform/main/com/haulmont/addon/bi/cuba-bi-pentaho/1.6.0/cuba-bi-pentaho-1.6.0-plugin.zip[cuba-bi-pentaho-1.6.0-plugin.zip], распакуйте архив и скопируйте папку `saiku-cuba-bi` в папку `$PENTAHO_HOME/pentaho-server/pentaho-solutions/system`.

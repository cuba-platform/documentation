...
You can use process variables as method arguments, including the variables automatically created on process start (entityId, bpmProcInstanceId, etc. as described in <<services.adoc#process-runtime-service>>).

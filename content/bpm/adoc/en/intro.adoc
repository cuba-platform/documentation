...
CUBA business process management subsystem is based on the Activiti framework, therefore general knowledge on  the framework is beneficial. See http://www.activiti.org o learn more about the Activity framework.

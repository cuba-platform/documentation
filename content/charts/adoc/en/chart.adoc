...
In addition to XML configuration, you can use a custom JSON to configure your chart using http://docs.amcharts.com/3/javascriptcharts[AmCharts configuration].

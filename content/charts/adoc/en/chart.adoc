...
* `StockGraphClickListener` - click on the stock graph click.
...
Above the listeners, `SeriesBasedChart` interface contains `zoomOut`, `zoomToIndexes`, and `zoomToDates` methods for manipulating the category axis.

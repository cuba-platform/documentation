...
Additionally to XML configuration you can use a custom JSON to configure your chart using http://docs.amcharts.com/3/javascriptcharts[AmCharts configuration].
...
And now we can change the chart configuration. As example, we can add a title:
...
Or you can set JSON configuration in the XML:

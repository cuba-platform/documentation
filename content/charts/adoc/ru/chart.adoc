...
* `chart:balloon` - задаёт настройки всплывающих подсказок, появляющихся при наведении курсора мыши на элемент данных диаграммы. Текст подсказки указывается в атрибуте `balloonText` для каждого графа. Например:
+
--
...
* `chart:chartScrollbar` (for <<serial_chart>> and <<xy_chart>>) - полоса прокрутки диаграммы.
+
--
...
* `chart:cursor` - необязательный элемент для добавления курсора к диаграмме. Курсор может следовать за указателем мыши и показывать подсказки со значением соответствующей точки диаграммы.
+
--
...
<chart:funnelChart id="ratingChart"
    ...
    <chart:data>
        <chart:item>
            ...
            <chart:property name="count" value="1"/>
        </chart:item>
        <chart:item>
...
Для более подробной информации об этом типе диаграмм см. http://docs.amcharts.com/3/javascriptcharts/AmGanttChart[AmCharts documentation].
...
. С помощью элемента `chart:data`.
+
Вложенные элементы `item` позволяют вручную указать фиксированные значения диаграммы.
+
[source, xml]
----
<chart:pieChart id="pieChart"
    ...
    <chart:data>
        <chart:item>
            ...
            <chart:property name="value" value="70"/>
        </chart:item>
        <chart:item>
            <chart:property name="key" value="piece of blueberry pie"/>
            <chart:property name="value" value="20"/>
        </chart:item>
        <chart:item>
...
Для более подробной информации об этом типе диаграмм см. http://docs.amcharts.com/3/javascriptcharts/AmPieChart[AmCharts documentation].
...
Для более подробной информации об этом типе диаграмм см. http://docs.amcharts.com/3/javascriptcharts/AmSerialChart[AmCharts documentation].
...
Для более подробной информации об этом типе диаграмм см. http://docs.amcharts.com/3/javascriptcharts/AmXYChart[AmCharts documentation].

...
Помимо XML-конфигурации, возможно использование JSON для конфигурации графика, используя http://docs.amcharts.com/3/javascriptcharts[конфигурацию AmCharts].

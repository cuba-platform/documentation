...
* *Annotate...*, используемый для добавления заметок и векторных аннотаций. Иинформацию о плагине для создания аннотаций вы можете найти https://www.amcharts.com/export-now-supports-annotating-charts-with-text-icons-arrows/[здесь].
...
`com/company/sampler/web/screens/column3d-chart.xml` в поле *Descriptor*. В полях *Id*, *Controller Name* и

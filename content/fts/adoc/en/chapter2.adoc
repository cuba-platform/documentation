...
. Use the `BookPublication` entity and the functionality of file upload described in the _File Storage_ section of the _Developer's Manual_ to illustrate search function for the loaded files.

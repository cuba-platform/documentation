...
*Full text search* can be used combined with link:{main_man_url}/gui_Filter.html[generic Filters] and link:{main_man_url}/folders_pane.html[Application/Search Folders]. You can add one FTS condition to any number of filter conditions.

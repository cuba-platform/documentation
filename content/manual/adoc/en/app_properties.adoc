...
+
--
Defines the REST API subversion. If the value is set to `1`, the REST API of the platform versions before 5.4 is used. Setting the value to `2` enables the REST API subversion with support for service calls. This property is valid for the <<rest_api,REST API v1>> only.

...
+
--
Allows you to completely disable opening the developer console in browser by adding `?debug` to the application URL, and, therefore, disabling the Javascript debug mode.

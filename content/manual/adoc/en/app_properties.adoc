...
+
--
<<additive_app_properties,Additive>> property defining an <<icon_set,icon set>> for an application <<app_tiers,block>>.
...
[source, plain]
----
cuba.icons.iconSets = +com.company.demo.web.MyIconSet
----
--

...
+
--
When `false`, indicates that the <<entity_attribute_access_changes,new mechanism>> of defining Entity Attribute Access Control handlers is used. If `true`, the old Spring application event handlers are used.

...
Application components can use this <<additive_app_properties,additive>> property to set URL patterns that should not be processed by the <<rest_api_v2,REST API>>.

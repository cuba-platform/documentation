...
The constraint name can be used to display a localized message that indicates what entity is concerned. For this, the <<main_message_pack,main message pack>> should contain keys equal to constraint names and be in uppercase. For example:

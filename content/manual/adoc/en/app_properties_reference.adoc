...
+
--
If set to `true`, turns on checking entity attribute permissions on Middleware. When `false`, attribute permissions are checked on the client tier, e.g. in <<gui_framework,Generic UI>> or {rest_man_url}[REST API].

...
.Firstly the new `enumeration` is created to set the constants.
[[figure_enumAttr1]]
image::enum_attributes_1.png[align="center"]

.Then this `enum` class is added to the entity as a new attribute.
[[figure_enumAttr2]]
image::enum_attributes_2.png[align="center"]

Access methods in the entity class will be the following:

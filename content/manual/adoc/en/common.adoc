...
* You can optionally set `@Secret` annotation for a particular property if the <<gui_PasswordField,PasswordField>> need to be used for displaying the property value in the "Application properties" screen.

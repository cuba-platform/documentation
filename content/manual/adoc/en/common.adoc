...
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/StandardEntity.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/BaseUuidEntity.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/BaseLongIdEntity.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/BaseStringIdEntity.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/BaseIdentityIdEntity.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/BaseGenericIdEntity.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/package-summary.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/EnableRestore.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/Extends.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/Listeners.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/annotations/MetaClass.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/annotations/NamePattern.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/SystemLevel.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/TrackEditScreenHistory.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/CaseConversion.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/annotations/Composition.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/EmbeddedParameters.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/IgnoreUserTimeZone.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/LocalizedValue.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/Lookup.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/annotations/MetaProperty.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/annotations/NumberFormat.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/OnDelete.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/entity/annotation/OnDeleteInverse.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
. The `UNLINK` policy for one-to-many and many-to-many collection attributes is not supported: `UnsupportedOperationException` will be thrown if you try to delete an entity instance on the owner side of the association. For example, the following delete policy will not work:
+
`Owner.java`
+
[source, java]
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/model/Session.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/model/MetaModel.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/model/MetaClass.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/model/MetaProperty.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/chile/core/datatypes/Datatype.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/View.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
`CachingFacadeMBean` provides methods to clear various caches in the http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/jmx/CachingFacadeMBean.html[Middleware] and http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/web/jmx/CachingFacadeMBean.html[Web Client] blocks.
...
`ConfigStorageMBean` enables viewing and setting values of the <<app_properties,application properties>> in the http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/jmx/ConfigStorageMBean.html[Middleware], http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/web/jmx/ConfigStorageMBean.html[Web Client] and http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/portal/jmx/ConfigStorageMBean.html[Web Portal] blocks.
...
http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/jmx/EmailerMBean.html[EmailerMBean] enables viewing the current values of the <<email_sending,email sending>> parameters, and sending test messages.
...
http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/jmx/PersistenceManagerMBean.html[PersistenceManagerMBean] provides the following abilities:
...
http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/jmx/ScriptingManagerMBean.html[ScriptingManagerMBean] is the JMX facade for the <<scripting,Scripting>> infrastructure interface.
...
http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/jmx/ServerInfoMBean.html[ServerInfoMBean] provides the general information about this Middleware block: the build number, build date and the <<serverId,server id>>.
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/Configuration.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/Messages.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/MessageTools.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/Metadata.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/MetadataTools.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/Resources.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/Scripting.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/Security.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/TimeSource.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/UserSessionSource.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/UuidSource.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/DataManager.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
`DataManager` in fact just delegates to a <<data_store,DataStore>> implementation and handles cross-database references if needed. The most implementation details described below are in effect when you work with entities stored in a relational database through the standard `RdbmsStore`. For another type of data store, everything except the interface method signatures can be different. For simplicity, when we write "DataManager" without additional clarification, we mean "DataManager via RdbmsStore".
...
Attribute permissions will be enforced only if you additionally set the <<cuba.entityAttributePermissionChecking,cuba.entityAttributePermissionChecking>> application property to true.
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/EntityStates.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/PersistenceHelper.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/global/Events.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/6.8/com/haulmont/cuba/core/sys/AppContext.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
The mechanism works as follows (see also <<entity_attribute_access_changes,changes in version 6.8.1>> below):

* When <<dataManager,DataManager>> loads an entity, it sends a Spring application event of the `SetupAttributeAccessEvent` type. The event object contains the loaded instance in the managed state, and three collections of attribute names: read-only, hidden and required (they are initially empty).
...
* Create a <<managed_beans,managed bean>> in the *core* module of your project. The bean must have the default singleton scope.
...
[[entity_attribute_access_changes]]
Changes in version 6.8.1::
+
--
Due to the problems encountered when access control handlers were implemented as Spring application event listeners, the mechanism was changed in the platform 6.8.1. The above rules are still in place by default, but the alternative way of implementing handlers has been introduced. The new way is turned on by the <<cuba.useSpringApplicationEventsToSetupAttributeAccess,cuba.useSpringApplicationEventsToSetupAttributeAccess>> application property and will be the default and only way for version 6.9+. So we recommend you refactoring your handlers to conform to the new rules explained below.

The handler must be a <<managed_beans,managed bean>> defined in the *core* module of your project and implementing the `SetupAttributeAccessHandler` interface. The bean must have the default singleton scope. You have to implement the interface methods:

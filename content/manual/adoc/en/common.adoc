...
+
--
Specifies the numeric type for the currency value attribute and indicates that the <<gui_CurrencyField,CurrencyField>> component should be used to display this attribute's value.

Parameters:

* `name` - the text that will be used as the currency label value.

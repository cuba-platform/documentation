...
+
--
It is published right after initialization of Servlet and Application contexts and enables to register custom Servlets, Filters and Listeners, see <<servlet_registration>>.

This event contains application and servlet contexts required for filter and servlets <<servlet_registration,registration>>.
--

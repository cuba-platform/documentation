...
This pack consists of 4 files – one for Russian, one for French, one for American English, and a default file. The name of the pack is `com.abc.sales.gui.customer`.

...
** `datatype` - the datatype descriptor. It has one mandatory attribute: `class`, which defines the implementation class. Other attributes are optional and depend on the implementation. See <<datatype_custom_example,>>.

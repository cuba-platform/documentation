...
A set of `permissions.xml` files, including the ones defined in <<app_components,application components>>, is declared in the <<cuba.permissionConfig,cuba.permissionConfig>> application property.
...
A set of `persistence.xml` files, including the ones defined in <<app_components,application components>>, is declared in the <<cuba.persistenceConfig,cuba.persistenceConfig>> application property.

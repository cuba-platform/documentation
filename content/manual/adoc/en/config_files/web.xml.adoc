...
The `web.xml` file is a standard descriptor of a Java web application and should be created for the Middleware, Web Client and Web Portal blocks.
...
In the `context-param` elements, the lists of <<app_components,application components>> and <<app_properties_files,application property files>> are defined.

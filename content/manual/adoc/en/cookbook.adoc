...
++++
<div class="manual-live-demo-container">
    <a href="http://localhost:8080/model/open?screen=sample$Airport.browse" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://localhost:8080/model/open?screen=sample$Airport.browse1" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://localhost:8080/model/open?screen=sample$Airport.browse2" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://localhost:8080/model/open?screen=sample$Airport.browse3" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
. The `Customer` entity contains an optional link to `CustomerDetails` annotated with `@Composition`:
+
[source, java]
----
include::{sourcesdir}/cookbook/composition_recipe_6.java[]
----

. The <<views,view>> of the customer editing screen contains the `details` attribute:
+
[source, xml]
----
include::{sourcesdir}/cookbook/composition_recipe_7.xml[]
----

. In the customer edit screen, a nested datasource for the `CustomerDetails` instance is defined:
+
[source, xml]
----
include::{sourcesdir}/cookbook/composition_recipe_8.xml[]
----

. The field group in the customer edit screen contains the `details` attribute:
+
[source, xml]
----
include::{sourcesdir}/cookbook/composition_recipe_9.xml[]
----

...
It is often convenient to edit the <<composition_oto_recipe,One-to-One composition>> in one single editor. Let's see how it can be implemented taking the https://github.com/cuba-platform/ui-recipes/blob/master/modules/web/src/sample/web/customer/Customer.java[Customer] and the https://github.com/cuba-platform/ui-recipes/blob/master/modules/web/src/sample/web/customer/CustomerDetails.java[CustomerDetails] relationship as an example.

...
:proj_model: https://git.haulmont.com/krivopustov/sample-model
...
<div class="manual-live-demo-container">
    <a href="http://cubadev:7081/business-logic/open?screen=sample$Customer.browse_1" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7081/business-logic/open?screen=sample$Customer.browse_2" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7081/business-logic/open?screen=sample$Customer.browse_3" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
http://cubadev:7081/business-logic/rest/v2/services/sample_DiscountService/calculateDiscount?customerId=1797f54d-5bec-87a6-4330-d958955743a2
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7081/business-logic/open?screen=sample$orderBrowseWithCustomers" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7081/business-logic/open?screen=jmxConsole" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7081/business-logic/open?screen=sample$Employee.browse" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$Customer.browse" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$customersWithAddresses" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$Customer.browse1" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$Airport.browse" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$Airport.browse1" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
* {proj_model}/blob/master/modules/global/src/com/company/sample/views.xml[views.xml] - the `terminal-meetingPoints-view` view of the `Terminal` class contains the `meetingPoints` collection attribute. This view is used in the `airport-terminals-meetingPoints-view` view of the `Airport` editor.
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$Airport.browse2" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$Airport.browse3" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
++++
<div class="manual-live-demo-container">
    <a href="http://cubadev:7082/model/open?screen=sample$Customer.browse2" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++
...
|DataManager executes only JPQL queries. Besides, it has a separate method for loading scalar values and aggregates: `loadValues()`. Queries for single attributes or aggregates (SUM, COUNT) will fail if issued via `load()` or `loadList()`.

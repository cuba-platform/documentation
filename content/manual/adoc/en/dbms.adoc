[[dbms]]
=== Database Components
This section provides information on how to configure the application for working with particular DBMS. Furthermore, a script-based mechanism, which enables creating a new database and keeping it up-to-date throughout the entire cycle of the development and operation of the application, is described.
...
Some additional information on working with the database is provided in <<chapter_db>> section.

...
* `portalContextPath` - a web context name for the *portal* module running in the single Uber JAR.

* `jettyConfPath` - a path to the Jetty server configuration file. See https://www.eclipse.org/jetty/documentation/9.4.x/jetty-xml-config.html.

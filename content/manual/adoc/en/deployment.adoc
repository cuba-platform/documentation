...
Copy credentials from the site and paste them in the file.
...
[source]
----
include::{sourcesdir}/deployment/direct_proxy[]
----
and restart Nginx
----
...
Create Nginx site configuration file `/etc/nginx/sites-enabled/root_proxy` and restart Nginx:
----

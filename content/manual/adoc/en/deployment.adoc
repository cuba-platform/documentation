...
. Assemble and deploy the project to the default Tomcat server in order to get locally all necessary dependencies.
...
+
--
* Setup WildFly, for example, to `C:\wildfly`.
...
+
--
* Start WildFly by running the `standalone.bat`
...
. Your application will become available on http://localhost:8080/app. The log files will be saved in the application working directory: `C:\Users\me\app_home\logs`.

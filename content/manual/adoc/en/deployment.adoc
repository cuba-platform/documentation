...
----
Set up the single Uber JAR as it described in the <<single_jar_deployment>> section. Then run the `pushImage` task from the terminal or from the *Search* field in Studio.
...
Set up the single Uber JAR as it described in the <<single_jar_deployment>> section. Create a Heroku account and install Heroku CLI. For this purpose, please, refer to the <<heroku_war_deployment>> section.

...
image::heroku_view_postgres_creds_1.png[align="center"]
...
image::heroku_view_postgres_creds_2.png[align="center"]
...
[source]
----
heroku jar:deploy webapp-runner.jar --includes libs/postgresql.jar:libs/tomcat-dbcp.jar:modules/core/web/META-INF/war-context.xml:build/distributions/war/app.war --app morning-beach-4895
----
...
[source]
----
heroku jar:deploy webapp-runner.jar --includes libs\postgresql.jar;libs\tomcat-dbcp.jar;modules\core\web\META-INF\war-context.xml;build\distributions\war\app.war --app morning-beach-4895
----

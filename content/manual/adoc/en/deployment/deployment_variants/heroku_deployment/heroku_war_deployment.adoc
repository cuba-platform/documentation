...
* Open your CUBA project in Studio, navigate to *Deployment*, go to *WAR settings* tab and then configure options as described below.
+
** Select *Build WAR*
...
+
--
Build WAR file by executing the `buildWar` Gradle task:

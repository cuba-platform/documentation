...
This was an example of using the `FileLoader` on the client tier. In the next example we'll consider the task of no-UI files saving on the core tier.

[[fileLoader_recipe_core]]
===== Saving Files to FileStorage on Core

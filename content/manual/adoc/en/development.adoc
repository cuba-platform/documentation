...
----
+
- To start and stop Nexus as a service, install the wrapper:
+
[source]
----
nexus.bat install
...
- Provider: Maven2
- Repository ID: *cuba-releases*
- Repository Name: *cuba-releases*
...
Create a Repository Group, in Nexus click *Add*, then choose *Repository Group*, add the repository previously created to this group and fill the following fields:

- Group ID: cuba-group
- Group Name: cuba-group
- Provider: Maven2
- Ordered Group Repositories: first *Central*, then *cuba-releases*
...
- Click *Save*
- Add the repository previously created to the group *cuba-group*.

Find the new repository URL at the top of the screen:
----
...
- Install another copy of the repository manager in the target network and copy the contents of the downloaded cache into it.
...
To make isolated repository operable, you need to copy the following folder from the first server (the path may differ according to your custom settings)
----

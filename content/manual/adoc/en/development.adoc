...
===== Configuring CUBA Studio to Use the Isolated Repository
...
- Fill your actual Repository URL in the Studio Server window, for example, `http://localhost:8081/nexus/content/groups/cuba-group`.

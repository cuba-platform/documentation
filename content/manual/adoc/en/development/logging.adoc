...
Logs for the Middleware, Web Client and Web Portal <<app_tiers,blocks>> are configured at the application server level; in <<fast_deployment,fast deployment>> mode the server is Tomcat.

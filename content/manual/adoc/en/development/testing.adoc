...
[TIP]
====
Learn https://www.cuba-platform.com/guides/integration-testing-middleware[Middleware Integration Testing in CUBA Applications] guide, which gives examples of middleware integration testing and shows how testing in general works in CUBA applications.

https://www.cuba-platform.com/guides/unit-testing[Unit Testing in CUBA Applications] guide deals with the question of how unit tests can be executed and when it makes sense to use them over integration testing.
====

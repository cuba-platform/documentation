...
[TIP]
====
See https://www.cuba-platform.com/guides/integration-testing-middleware[Middleware Integration Testing in CUBA Applications] guide to learn examples of middleware integration testing. It also shows how testing in general works in CUBA applications.

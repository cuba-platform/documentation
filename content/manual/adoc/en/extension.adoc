...
To use servlets and security filters defined in the <<app_components,application component>>, you need to register them in the component to be used the owning application. The servlets are normally registered in the <<web.xml,web.xml>> configuration file, however, this configuration is not propagated in the application where this app component is used.

...
Here, the `WebInitializer` class has only one event listener which is used to register an HTTP servlet from an application component in the owner application. Now, if you add this app component to you application, `MyHttpServlet` will be registered right after the initialization of servlet and application contexts.

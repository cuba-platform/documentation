...
CUBA platform provides support of HTML pages and Javascript with the help of REST API. To use Javascript in your application, download and place in your project folder a jQuery library and import it in your screen file. For better styling you may use Bootstrap framework which `.css` file should also be placed in the project folder.
...
This screen is created in the *web* module as `customers.html` file and is available in the running application by its relative path added to URL:

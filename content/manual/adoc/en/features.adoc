...
In the CUBA application, predefined JPQL queries must be specified in files defined by the <<cuba.rest.queriesConfig, cuba.rest.queriesConfig>> application property of the *web* or *portal* module (e.g in the `web-app.properties file`):
...
The content of the `myapp-rest-queries.xml` must be placed to the main package of the *web* or *portal* module (e.g. `com.company.myapp`) and should be as follows:
...
The example of how to configure and execute a query can be found in the <<rest_api_v2_ex_query>> chapter.

[[rest_api_v2_services_config]]
===== Services Configuration

The list of service methods that are available via the REST API must be configured in the CUBA application in files defined by the <<cuba.rest.servicesConfig, cuba.rest.servicesConfig>> application property of the *web* or *portal* module (e.g in the `web-app.properties file`):
...
The content of the `myapp-rest-services.xml` must be placed to the main package of the *web* or *portal* module (e.g. `com.company.myapp`) and should be as follows:
...
The example of how to configure and invoke a service can be found in the <<rest_api_v2_ex_service_get>> chapter.

...
Current lock state can be tracked via the `app-core.cuba:type=LockManager `JMX bean or through a dedicated screen available at *Administration* -> Locks. This screen also enables forced unlocking of any object.

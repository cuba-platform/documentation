...
. The new controller runs the context of the `CubaRestApiServlet`. So the URL for controller methods will start with the `/rest`, i.e. the doSmth() method will be accesed by the URL: `http://localhost:8080/app-portal/rest/myapi/dosmth`.
+
[WARNING]
====

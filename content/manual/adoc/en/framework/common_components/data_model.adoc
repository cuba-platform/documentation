...
[TIP]
====
See our guides to learn about data modeling in CUBA applications.  https://www.cuba-platform.com/guides/data-modelling-many-to-many-association[Data Modelling: Many-to-Many Association] guide shows different use cases of many to many associations. https://www.cuba-platform.com/guides/data-modelling-composition[Data Modelling: Composition] guide shows various examples of a composition relationship between entities. 
====

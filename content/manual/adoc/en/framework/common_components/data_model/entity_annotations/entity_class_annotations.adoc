...
[TIP]
====
See https://www.cuba-platform.com/guides/initial-entity-values[Initial Entity Values] guide to learn an example of defining certain initial values directly within the `Entity` class via the `@PostConstruct` annotation.
====

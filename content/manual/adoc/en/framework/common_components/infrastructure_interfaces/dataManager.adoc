...
[TIP]
====
See https://www.cuba-platform.com/guides/intro-working-with-data-in-cuba[Introduction to Working with Data] guide to learn different use cases regarding programmatic data access with the DataManager API.
====

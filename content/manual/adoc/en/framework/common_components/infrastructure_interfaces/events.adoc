...
[TIP]
====
Learn https://www.cuba-platform.com/guides/decouple-business-logic-with-app-events[Decouple Business Logic with Application Events] guide, which shows different examples of application events.
====

...
`ConfigStorageMBean` enables viewing and setting values of the <<app_properties,application properties>> in the http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/core/jmx/ConfigStorageMBean.html[Middleware], http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/web/jmx/ConfigStorageMBean.html[Web Client] and http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/portal/jmx/ConfigStorageMBean.html[Web Portal] blocks.

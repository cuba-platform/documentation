...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/core/jmx/PersistenceManagerMBean.html[PersistenceManagerMBean] provides the following abilities:

...
http://files.cuba-platform.com/javadoc/cuba/7.1/com/haulmont/cuba/core/jmx/ScriptingManagerMBean.html[ScriptingManagerMBean] is the JMX facade for the <<scripting,Scripting>> infrastructure interface.

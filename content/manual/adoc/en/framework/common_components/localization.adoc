...
[TIP]
====
Learn https://www.cuba-platform.com/guides/localization-in-cuba-applications[Localization in CUBA applications] guide, which demonstrates how localized messages within the CUBA application can be defined and used.
====

...
[TIP]
====
See https://www.cuba-platform.com/guides/create-business-logic-in-cuba#client_tier_beans[Create Business Logic in CUBA] guide to learn how to put business logic as a Spring bean.
====

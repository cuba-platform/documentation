...
Legacy screens provide backward compatibility. Consider an example of extending screens of the entity `User`.

Below is an example descriptor of the `ExtUser` entity browser screen:
...
*Extend screens using CUBA Studio*
...
As the screen identifier `customers_Customer.browse` matches the identifier of a base screen, a new screen will be invoked everywhere instead of the old.

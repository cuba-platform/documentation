...
The parameter below can be configured only in Java code. In order to generate correctly annotated method stub for it, use *Handler* tab of the *Component Inspector* tool window in Studio.

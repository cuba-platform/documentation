...
CreateAction is a <<standard_list_actions,list action>> designed to create new entity instances. It instantiates a new instance and opens the entity edit screen with the created instance. After the instance is saved to the database by the edit screen, the action adds it to the data container of the UI component.

...
. Optionally, mark facet interface and its methods with <<own_component_in_studio,metadata annotations>> to add support for the facet in the Screen Designer of the CUBA Studio.

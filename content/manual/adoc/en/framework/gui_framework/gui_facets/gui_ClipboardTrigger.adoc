...
`ClipboardTrigger` is a <<gui_facets,facet>> which allows a user to copy text from a field to the clipboard. It is defined in the `facets` element of the screen XML descriptor and has the following attributes:

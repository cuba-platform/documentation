...
[[editorScreens]]
Using the EditorScreens bean::
+
--
The `EditorScreens` bean allows you to open entity editor screens with various parameters.

Below is an example of opening a default editor for the `Customer` entity instance:

[source, java]
----
include::{sourcesdir}/gui/screens/editorScreens_1.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui/screens/editorScreens_2.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui/screens/editorScreens_3.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui/screens/editorScreens_4.java[]
----
--

[[lookupScreens]]
Using the LookupScreens bean::
+
--
The `LookupScreens` bean allows you to open entity lookup screens with various parameters.

Below is an example of opening a default lookup screen of the `User` entity:

[source, java]
----
include::{sourcesdir}/gui/screens/lookupScreens_1.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui/screens/lookupScreens_2.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui/screens/lookupScreens_3.java[]
----
--
...
[TIP]
====
Learn https://www.cuba-platform.com/guides/decouple-business-logic-with-app-events#cuba_ui_events[Decouple Business Logic with Application Events] guide, which shows examples of using events on the UI layer.
====
...
[TIP]
====
Learn https://www.cuba-platform.com/guides/initial-entity-values#internal_initialization_via_initentityevent[Initial Entity Values] guide, which shows an example of using internal initialization via `InitEntityEvent`.
====
+

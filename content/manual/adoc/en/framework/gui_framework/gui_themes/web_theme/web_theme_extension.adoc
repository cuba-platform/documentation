...
A convenient way to do this is to use *CUBA Studio*: open the *Project properties* section and click *Create theme extension*. Select the theme you want to extend in the popup window. Another way is to use the `theme` command in https://www.cuba-platform.com/marketplace/cuba-cli[CUBA CLI].

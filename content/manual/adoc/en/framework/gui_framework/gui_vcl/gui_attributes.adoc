...
+
--
Sets the expand ratio for the component placed in `vbox` or `hbox`, see also the <<gui_attr_expand,expand>> attribute. The ratio must be greater than or equal to 0.
...
+
--
Sets maximum CSS height for window <<screen_xml_layout,layout>>. For example, `"640px"`, `"100%"`.
--
...
+
--
Sets minimum CSS height for window <<screen_xml_layout,layout>>. For example, `"640px"`, `"auto"`.
--
...
+
--
Sets maximum CSS width for window <<screen_xml_layout,layout>>. For example, `"640px"`, `"100%"`.
--
...
+
--
Sets minimum CSS width for window <<screen_xml_layout,layout>>. For example, `"640px"`, `"auto"`.

[source, xml]
----
<layout minWidth="640px" minHeight="200px">
    <textField caption="Demo 100% width min content width"
               width="800px"/>
</layout>
----
--

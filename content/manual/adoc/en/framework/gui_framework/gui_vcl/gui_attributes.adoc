...
<<gui_Table,Table>>, <<gui_TreeDataGrid,TreeDataGrid>>, or <<gui_TreeTable,TreeTable>> at XML load time, thus you can set the items programmatically in a screen controller.

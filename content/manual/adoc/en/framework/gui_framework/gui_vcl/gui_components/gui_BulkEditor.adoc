...
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/gui/components/BulkEditor.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
[WARNING]
====
`BulkEditor` works only in screens based on <<gui_legacy,legacy API>>. The similar functionality for the current API is provided by the <<gui_BulkEditAction,BulkEditAction>>.
====

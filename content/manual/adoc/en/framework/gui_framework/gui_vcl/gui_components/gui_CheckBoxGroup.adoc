...
<div class="manual-live-demo-container">
    <a href="https://demo.cuba-platform.com/sampler/open?screen=checkboxgroup-simple" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++

++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.2/com/haulmont/cuba/gui/components/CheckBoxGroup.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
[[gui_CheckBoxGroup_setOptionDescriptionProvider]]
...
[source, java]
----
include::{sourcesdir}/gui_vcl/gui_CheckBoxGroup_9.java[]
----

[source, java]
----
include::{sourcesdir}/gui_vcl/gui_CheckBoxGroup_10.java[]
----
--
...
<<gui_CheckBoxGroup_setOptionDescriptionProvider,setOptionDescriptionProvider>> -

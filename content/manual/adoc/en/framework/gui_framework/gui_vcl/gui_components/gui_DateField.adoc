...
* To create a date field associated with data, you should use the <<gui_attr_dataContainer,dataContainer>>/<<gui_attr_datasource,datasource>> and <<gui_attr_property,property>> attributes:
+
[source, xml]
----

...
[TIP]
====
Learn https://www.cuba-platform.com/guides/working-with-images[Working with Images in CUBA applications] guide, which demonstrates how to upload and display images in the application.
====
...
<<gui_Image_setValueSource,setValueSource>>

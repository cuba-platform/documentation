...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.2/com/haulmont/cuba/gui/components/LookupField.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
[[gui_LookupField_optionsContainer]]
...
* The `setOptionImageProvider()` method allows you to define images for the options displayed by the `LookupField` component. This method sets a function that accepts one of the <<gui_Image_ResourceType,resource types>>.
+
[source, java]
----
...
<<gui_LookupField_optionsContainer,optionsContainer>> -

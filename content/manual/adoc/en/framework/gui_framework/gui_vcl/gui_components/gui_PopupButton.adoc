...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.2/com/haulmont/cuba/gui/components/PopupButton.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
The appearance of the `PopupButton` component can be customized using SCSS variables with `$cuba-popupbutton-*` prefix. You can change these variables in the visual editor after creating a <<web_theme_extension,theme extension>> or a <<web_theme_creation,custom theme>>.

...
<div class="manual-live-demo-container">
    <a href="https://demo.cuba-platform.com/sampler/open?screen=datasource-suggestionfield" class="live-demo-btn" target="_blank">LIVE DEMO</a>
</div>
++++

++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.2/com/haulmont/cuba/gui/components/SuggestionField.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
The appearance of the `SuggestionField` component can be customized using SCSS variables with `$cuba-suggestionfield-*` prefix. You can change these variables in the visual editor after creating a <<web_theme_extension,theme extension>> or a <<web_theme_creation,custom theme>>.

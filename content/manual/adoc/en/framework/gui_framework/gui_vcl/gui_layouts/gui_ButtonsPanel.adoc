...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/gui/components/ButtonsPanel.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
[TIP]
====
The caption of `buttonsPanel` located inside the list component (<<gui_Table>>, <<gui_TreeTable>>, <<gui_GroupTable>>, <<gui_DataGrid>>, <<gui_TreeDataGrid>>, <<gui_Tree>>) will be ignored. Only the list component caption will be displayed.
====

...
DecimalMaxValidator::
+
It checks that value must be less than or equal to the specified maximum.
...
* `inclusive` − when set to `true`, the value must be less than or equal to the specified maximum value. The default value is `true`;
...
DecimalMinValidator::
+
It checks that value must be greater than or equal to the specified minimum.
Supported types: `BigDecimal`, `BigInteger`, `Long`, `Integer`, and `String` that represents `BigDecimal` value with the current locale.
+
It has the following attributes:
+
...
* `inclusive` − when set to `true`, the value must be greater than or equal to the specified minimum value. The default value is `true`;
...
It checks that value must be a number within the accepted range.
Supported types: `BigDecimal`, `BigInteger`, `Long`, `Integer`, and `String` that represents `BigDecimal` value with the current locale.
+
It has the following attributes:
+
...
+
It checks that value should be a less than or equal 0.
...
NegativeValidator::
+
It checks that value should be strictly less than 0.
Supported types: `BigDecimal`, `BigInteger`, `Long`, `Integer`, `Double`, `Float`.
+
It has the following attributes:
+
...
+
It validates that date or time in the past or present.
It doesn't use Groovy string, so there are no parameters you can pass to the error message.
Supported types: `java.util.Date`, `LocalDate`, `LocalDateTime`, `LocalTime`, `OffsetDateTime`, `OffsetTime`.
+
It has the following attributes:
...
PastValidator::
+
It validates that date or time in the past.
It doesn't use Groovy string, so there are no parameters you can pass to the error message.
Supported types: `java.util.Date`, `LocalDate`, `LocalDateTime`, `LocalTime`, `OffsetDateTime`, `OffsetTime`.
+
It has the following attributes:
...
+
It checks that value should be greater than or equal to 0.
Supported types: `BigDecimal`, `BigInteger`, `Long`, `Integer`, `Double`, `Float`.
+
It has the following attributes:
+
...
PositiveValidator::
+
It checks that value should be strictly greater than 0.
Supported types: `BigDecimal`, `BigInteger`, `Long`, `Integer`, `Double`, `Float`.
+
It has the following attributes:
+

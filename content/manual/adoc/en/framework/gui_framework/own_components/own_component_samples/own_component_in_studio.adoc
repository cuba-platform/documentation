...
Here the `scrollBar` is a part of the main `myChart` component and not an independent component, so we need to declare attributes metadata in the main component interface.

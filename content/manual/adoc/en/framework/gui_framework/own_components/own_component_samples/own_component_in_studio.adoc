...
<<component_metadata_facet_definition,Facet (non-visual component) definition>>
...
* <<gui_facets,Facets>> or Non-Visual Components - marked with `@StudioFacet`.
...
* `@StudioFacet` - indicates that the annotated interface should be available in the Screen Designer as a facet (non-visual component). Provides necessary attributes for panels of the Screen Designer. The annotated interface must be a direct or indirect sub-interface of the `com.haulmont.cuba.gui.components.Facet`.
...
Facet (non-visual component) definition::
--

...
The `getRouteGenerator()` method of `UrlRouting` bean allows you to get an instance of `RouteGenerator`. `RouteGenerator` provides API to generate routes for screens with optional URL parameters. It has the following methods:

...
[TIP]
====
See https://www.cuba-platform.com/guides/anonymous-access-and-social-login[Anonymous Access & Social Login] guide to learn how to set up public access to some screens of the application and implement custom login using a Google, Facebook, or GitHub account.
====

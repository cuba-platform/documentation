...
- `IdpAuthProvider` has been replaced with `IdpLoginProvider` that can be enabled as described in the https://github.com/cuba-platform/idp-addon/wiki[IDP addon wiki].

...
[TIP]
====
Learn https://www.cuba-platform.com/guides/decouple-business-logic-with-app-events#entity_changes_through_entitychangedevent[Decouple Business Logic with Application Events] guide, which shows using `EntityChangedEvent`.
====

...
[TIP]
====
Learn https://www.cuba-platform.com/guides/create-business-logic-in-cuba#middleware_services[Create Business Logic in CUBA] guide, which shows how to put business logic as a middleware service.
====

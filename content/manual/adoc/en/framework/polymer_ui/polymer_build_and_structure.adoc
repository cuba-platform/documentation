...
Polymer 2.x and its native elements are written using ES6, thus it requires an additional build step (ES6 → ES5 https://www.polymer-project.org/2.0/docs/es6[compilation]) in order to support old browsers.

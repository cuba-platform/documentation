...
[[gui_PickerField_actions]] [[gui_PickerField_addAction]]
...
[[gui_SideMenu_MenuItem_addChildItem]] [[gui_SideMenu_MenuItem_removeChildItem]]
...
<<gui_SideMenu_MenuItem_removeChildItem,removeChildItem>> -
...
** an optional `generator` attribute contains the link to the method in the screen controller that is used to define the custom visual component to the table cells:
+
[source, xml]
----

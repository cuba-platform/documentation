...
Filter can be made _global_ (i.e., available for all users) using the *Available to all users* checkbox, or default using the *Default* checkbox. This operation requires <<permissions, permission>>.

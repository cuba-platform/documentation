...
----
* `requestFocus()` method allows you to set focus on the concrete editable field of the concrete row. It takes two parameters: an item of entity and identifier of the column.
Example of requesting a focus:
+
[source, java]
----

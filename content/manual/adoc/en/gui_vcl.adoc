...
[[gui_DateField_range]]
* You can specify available dates by using `rangeStart` and `rangeEnd` attributes. If you set it, all the dates that are outside the range will be disabled. You can use date mask "yyyy-MM-dd" in XML or set range programmatically with `Date`
+
[source, xml]
----

...
* <<cuba.gui.genericFilterColumnsQty,cuba.gui.genericFilterColumnsQty>> - sets the default number of columns for placing conditions on the filter panel. See also <<gui_Filter_columnsQty,columnsQty>> filter attribute.

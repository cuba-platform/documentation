...
[WARNING]
====
Starting from the version 6.7 of the Platform the `Embedded` component is deprecated. Use the <<gui_Image,Image>> component for displaying images or the <<gui_BrowserFrame,BrowserFrame>> component for embedded web pages.
====
...
`SearchExecutor` can return any types of options: entities, strings, or enum values.

* Entities:

[source, java]
----
include::{sourcesdir}/gui_vcl/suggestionPickerField_4.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui_vcl/suggestionPickerField_5.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui_vcl/suggestionPickerField_6.java[]
----
...
[source, java]
----
include::{sourcesdir}/gui_vcl/suggestionPickerField_7.java[]
----

...
* The `fileSizeLimit` XML attribute (and the corresponding `setFileSizeLimit()` method) can be used to set maximum allowed file size specified in bytes. This limit defines a maximum size for each file.
+
[source, xml]
----

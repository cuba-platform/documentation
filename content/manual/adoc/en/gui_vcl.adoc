...
The attribute value should contain a path to an icon file relative to the <<gui_themes,themes>> folder or the icon name in the <<icon_set,icon set>>. For example:
...
For more details on the usage of icons see <<gui_icons>>.
--

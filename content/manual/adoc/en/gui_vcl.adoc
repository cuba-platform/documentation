...
* The `accept` XML attribute (and the corresponding `setAccept()` method) can be used to set the file type mask in the file selection dialog. The value of the attribute should be a comma-separated list of masks. For example: `++*.jpg,*.png++`.

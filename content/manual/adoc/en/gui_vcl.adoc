...
* Date accuracy can be defined using a `resolution` attribute. An attribute value should match the `DatePicker.Resolution` enumeration − `DAY`, `MONTH`, `YEAR`. Default is `DAY`, i.e., to within a day.
+
[source, xml]
----

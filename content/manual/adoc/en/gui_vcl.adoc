...
+
For example to set ability to drag splitter only between 100 and 300 pixels from the left side of the component:

[source, xml]
----
include::{sourcesdir}/gui_vcl/splitpanel_2.xml[]
----
Also, if you want to set this range programmatically, you need to specify a unit of value with `Component.UNITS_PIXELS` or `Component.UNITS_PERCENTAGE`

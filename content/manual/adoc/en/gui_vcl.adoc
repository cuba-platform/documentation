...
[WARNING]
====
Starting from the version 6.7 of the Platform the `Embedded` component is deprecated. Use the <<gui_Image,Image>> component for displaying images or the <<gui_BrowserFrame,BrowserFrame>> component for embedded web sites.
====

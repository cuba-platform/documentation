...
When used in <<folders_pane,Application/Search Folders>>, the folder can define hidden regular conditions and declare the FTS condition which is the only visible to the user:

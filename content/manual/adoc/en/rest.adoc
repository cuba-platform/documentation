...
<<cuba.rest.client.authorizedGrandTypes, cuba.rest.client.authorizedGrandTypes>> - a list of authorized grand types for the default client. To disable refresh tokens remove the `refresh_token` item from the property value.

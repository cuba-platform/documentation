...
You can use the *Jespa* library with the corresponding `CubaAuthProvider` described in the <<jespa,Jespa>> section in order to enable advanced integration with Active Directory, including Single Sign-On for Windows domain users.

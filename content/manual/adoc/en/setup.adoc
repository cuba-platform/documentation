...
[TIP]
====
CUBA {revnumber} supports Java 8, 9 and 10. If you don't need to work with projects based on previous CUBA versions (including migration to CUBA {revnumber}), then you can install Java 10.
====
+
[WARNING]
====
...
====
+
See also notes on <<runtime_java,deployment>>.

...
+
--
<<additive_app_properties,Аддитивное>> property defining a file that contains JSON transformation configurations used by the <<rest_api_v2,>> when the client needs data in format of some particular data model version.

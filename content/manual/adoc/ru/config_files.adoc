...
** `datatype` - описатель типа данных. Должен иметь атрибут `class`, задающий класс реализации. Другие атрибуты опциональны и зависят от реализации. См. <<datatype_custom_example,>>.

...
[[custom_theme_recipe]]
==== Создание новой темы Hover Dark

Все темы приложений CUBA можно <<web_theme_extension,расширять>> и модифицировать. Кроме того, вы можете создавать <<web_theme_creation,собственные темы>> на основе уже имеющихся.
...
. Создайте новую тему *hover-dark* в вашем проекте.

.. С помощью CUBA Studio:
+
...
.. С помощью https://github.com/cuba-platform/cuba-cli[CUBA CLI]:
+
--

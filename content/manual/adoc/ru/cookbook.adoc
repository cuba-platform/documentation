...
+
--
. Зарегистрируйтесь на https://bintray.com/signup/oss2
...
. Получите свой API key. Его можно найти через интерфейс Bintray в настройках профиля.
...
. Создайте переменные среды с данными пользователя Bintray:
+
[source, plain]
----
BINTRAY_USER=имя_пользователя_bintray

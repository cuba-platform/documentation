...
Вы можете использовать существующую базу Postgres или создать новую. Далее описываются шщаги по созданию новой БД.
...
Настройки проекта для развертывания::
+
--
...
Чтобы иметь возможность работать с командой `gradlew`, заранее создайте Gradle wrapper, использовав команду меню *Build*.
--
...
Приложение в данный момент разворачивается. Вы можете мониторить процесс по логам.
--
...
Чтоюы отслеживать данные в логах, запускайте в командной строке следующую команду:

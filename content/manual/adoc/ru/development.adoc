...
+
Версии с более подробным квалификатором считаются более старыми, нежели версии с более коротким квалификатором. К примеру, версия `0.3-SNAPSHOT` не будет заменена на `0.3.2-SNAPSHOT`, так как `0.3-SNAPSHOT` является менее специфичной и более свежей.
+

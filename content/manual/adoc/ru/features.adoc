...
Платформа CUBA позволяет добавлять в приложение HTML-страницы и Javascript с использованием REST API. Чтобы добавить код на Javascript в приложение, необходимо скачать и поместить в папку проекта библиотеку jQuery, а затем указать ссылку на неё в дескрипторе экрана. Для использования стилей можно использовать Bootstrap, также поместив его `.css`-файлы в папку проекта.
...
[source, javascript]
----
include::{sourcesdir}/features/rest_customers_script_1.js[]
----
...
[source, javascript]
----
include::{sourcesdir}/features/rest_customers_script_2.js[]
----

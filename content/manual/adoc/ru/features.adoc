...
. Задайде <<additive_app_properties,аддитивное>> свойство приложения `cuba.restSpringContextConfig` в файле свойств соответствующего модуля, например, в `portal-app.properties`:
+
[source, properties]
----

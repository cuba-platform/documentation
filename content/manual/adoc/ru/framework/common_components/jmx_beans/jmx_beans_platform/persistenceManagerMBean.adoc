...
http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/core/jmx/PersistenceManagerMBean.html[PersistenceManagerMBean] предоставляет следующие возможности:

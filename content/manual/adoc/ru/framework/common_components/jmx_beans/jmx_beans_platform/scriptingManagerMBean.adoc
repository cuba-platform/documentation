...
http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/core/jmx/ScriptingManagerMBean.html[ScriptingManagerMBean] является JMX-фасадом для интерфейса инфраструктуры <<scripting,Scripting>>.

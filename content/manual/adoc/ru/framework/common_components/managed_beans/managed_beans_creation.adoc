...
[TIP]
====
Руководство https://www.cuba-platform.com/guides/create-business-logic-in-cuba#client_tier_beans[Create Business Logic in CUBA] демонстрирует использование Spring-бина для реализации бизнес-логики.
====

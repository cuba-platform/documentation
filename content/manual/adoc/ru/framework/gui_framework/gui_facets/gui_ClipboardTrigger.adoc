...
`ClipboardTrigger` это <<gui_facets,фасет>>, позволяющий копировать текст из поля ввода в буфер обмена. Он задается в элементе `facets` XML-дескриптора экрана и имеет следующие атрибуты:

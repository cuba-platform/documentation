...
[TIP]
====
Руководство https://www.cuba-platform.com/guides/initial-entity-values#internal_initialization_via_initentityevent[Initial Entity Values] содержит пример процедуры внутренней инициализации с помощью `InitEntityEvent`.
====

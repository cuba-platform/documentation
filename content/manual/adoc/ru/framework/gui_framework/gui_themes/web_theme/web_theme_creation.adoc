...
Новые темы можно легко создавать в CUBA Studio, а также в https://github.com/cuba-platform/cuba-cli[CUBA CLI] или вручную. Рассмотрим все три способа создания новой темы на примере темы <<custom_theme_hover_dark,Hover Dark>>.
...
Создание темы с помощью https://github.com/cuba-platform/cuba-cli[CUBA CLI]: ::
+
--

...
<<gui_Table,Table>>, <<gui_TreeDataGrid,TreeDataGrid>> и <<gui_TreeTable,TreeTable>> на момент загрузки дескриптора экрана. Таким образом, вы можете указать данные для компонента программно в контроллере экрана.

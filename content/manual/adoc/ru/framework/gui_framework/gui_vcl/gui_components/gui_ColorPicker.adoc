...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/gui/components/ColorPicker.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
Для создания `ColorPicker`, связанного с данными, необходимо использовать атрибуты <<gui_attr_dataContainer,dataContainer>> и <<gui_attr_property,property>>.

...
<1> – Смотрите описание метода `createCloseButton` в классе https://demo.cuba-platform.com/sampler/open?screen=datagrid-detailsgenerator[DataGridDetailsGeneratorSample].
<2> – Смотрите описание метода `getContent` в классе https://demo.cuba-platform.com/sampler/open?screen=datagrid-detailsgenerator[DataGridDetailsGeneratorSample].

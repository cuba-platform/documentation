...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.2/com/haulmont/cuba/gui/components/DatePicker.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++
...
* Для создания `DatePicker`, связанного с данными, необходимо использовать атрибуты <<gui_attr_dataContainer,dataContainer>> и <<gui_attr_property,property>>:
+
[source, xml]
----

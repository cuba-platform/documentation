...
[TIP]
====
Руководство https://www.cuba-platform.com/guides/working-with-images[Working with Images in CUBA applications] демонстрирует, как использовать изображения в приложениях.
====

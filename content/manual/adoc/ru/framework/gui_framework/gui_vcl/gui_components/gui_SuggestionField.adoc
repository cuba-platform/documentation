...
++++
<div class="manual-live-demo-container">
    <a href="http://files.cuba-platform.com/javadoc/cuba/7.0/com/haulmont/cuba/gui/components/SuggestionField.html" class="api-docs-btn" target="_blank">API DOCS</a>
</div>
++++

...
* Атрибут `htmlSanitizerEnabled` разрешает или запрещает санитизацию HTML. Если атрибут `htmlSanitizerEnabled` установлен в значение `true`, содержимое компонента `HtmlBoxLayout` будет санитизировано.
+
--

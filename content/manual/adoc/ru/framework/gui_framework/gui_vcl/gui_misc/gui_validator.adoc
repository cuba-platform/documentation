...
DecimalMaxValidator::
+
Проверяет, что значение должно быть меньше или равно указанному максимальному значению.
...
DecimalMinValidator::
+
Проверяет, что значение должно быть больше или равно указанному минимальному значению.
Поддерживаемые типы: `BigDecimal`, `BigInteger`, `Long`, `Integer` и `String`, представляющий значение `BigDecimal` с текущей локалью.
+
Валидатор имеет следующие атрибуты:
+
...
Проверяет, что значение должно быть числом в пределах обозначенного диапазона.
Поддерживаемые типы: `BigDecimal`, `BigInteger`, `Long`, `Integer` и `String`, представляющий значение `BigDecimal` с текущей локалью.
+
Валидатор имеет следующие атрибуты:
+
...
+
--
* `checkSeconds` − если установлено значение `true`, валидатор должен сравнить дату или время с секундами и наносекундами. Значение по умолчанию − `false`;
...
+
Проверяет, что значение должно быть меньше или равно 0.
...
NegativeValidator::
+
Проверяет, что значение должно быть строго меньше 0.
Поддерживаемые типы: `BigDecimal`, `BigInteger`, `Long`, `Integer`, `Double`, `Float`.
+
Валидатор имеет следующие атрибуты:
+
...
+
Проверяет, что значение должно быть больше или равно 0.
Поддерживаемые типы: `BigDecimal`, `BigInteger`, `Long`, `Integer`, `Double`, `Float`.
+
Валидатор имеет следующие атрибуты:
+
...
PositiveValidator::
+
Проверяет, что значение должно быть строго больше 0.
Поддерживаемые типы: `BigDecimal`, `BigInteger`, `Long`, `Integer`, `Double`, `Float`.
+
Валидатор имеет следующие атрибуты:
+

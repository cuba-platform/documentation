...
- `IdpAuthProvider` заменён на `IdpLoginProvider`. Подробнее о технологии единого входа (SSO) см. в https://github.com/cuba-platform/idp-addon/wiki[документации] к дополнению IDP.

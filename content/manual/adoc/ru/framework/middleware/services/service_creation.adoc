...
[TIP]
====
Руководство https://www.cuba-platform.com/guides/create-business-logic-in-cuba#middleware_services[Create Business Logic in CUBA] демонстрирует использование среднего слоя для реализации бизнес-логики.
====

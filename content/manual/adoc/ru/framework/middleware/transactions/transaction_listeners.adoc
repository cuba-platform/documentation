...
Слушатель должен быть <<managed_beans,Spring-бином>>, реализующим один или оба интерфейса `BeforeCommitTransactionListener` и `AfterCompleteTransactionListener`.

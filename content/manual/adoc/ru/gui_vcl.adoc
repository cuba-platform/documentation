...
[[gui_GroupBox_panel]]
* `showAsPanel` – если указано значение `true`, то компонент будет выглядеть как link:https://vaadin.com/docs/-/part/framework/layout/layout-panel.html[Vaadin Panel].

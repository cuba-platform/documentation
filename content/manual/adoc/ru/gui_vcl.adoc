...
+
--
Атрибут, устанавливающий отображение или скрытие кнопки *Clear* компонента `TokenList`. Возможные значения − `true`, `false`. По умолчанию `true`.
--

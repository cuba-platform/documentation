...
К компоненту `Button` можно применить заданные <<gui_Button_stylenames,стили>>. Стили задаются в XML-дексрипторе или контроллере экрана:
[source, xml]
----
...
* К компоненту `DateField` можно применить заданный стиль `borderless`, чтобы удалить рамку и фон поля. Стили задаются в XML-дексрипторе или контроллере экрана:
+
[source, xml]
----
...
К компоненту `Label` можно применить заданные <<gui_Label_stylenames,стили>>. Стили задаются в XML-дексрипторе или контроллере экрана:
[source, xml]
----
...
* К компоненту `LookupField` можно применить заданные <<gui_LookupField_styles,стили>>. Стили задаются в XML-дексрипторе или контроллере экрана:
+
--
[source, xml]
----
...
[[gui_Table_stylename]]
* атрибут `stylename` позволяет применять к таблице заданные стили `Table`. Стили задаются в XML-дексрипторе или контроллере экрана:
+
--
[source, xml]
----
...
К компоненту `TextArea` можно применить заданные <<gui_TextArea_styles,стили>>. Стили задаются в XML-дексрипторе или контроллере экрана:
[source, xml]
----
...
* К компоненту `TextField` можно применить заданные <<gui_TextField_styles,стили>>. Стили задаются в XML-дексрипторе или контроллере экрана:
+
--
[source, xml]
----
...
К компоненту `groupBox` можно применить заданные стили. Стили задаются в XML-дексрипторе или контроллере экрана.

Чтобы использовать стиль `well`, дополнительно укажите стиль `v-panel-caption` для любого контейнера внутри `groupBox`, чтобы он выглядел как заголовок контейнера.
...
Чтобы применить стиль программно, выберите одну из констант класса `HaloTheme` с префиксом компонента `LAYOUT_` или `GROUPBOX_`. Например, для удаления полей и фона контейнера `groupBox` используйте стиль `borderless` совместно с атрибутом `showAsPanel`:
...
Атрибуты задаются в XML-дексрипторе или контроллере экрана:
[source, java]
----
...
К контейнеру `TabSheet` можно применить заданные <<gui_tabsheet_styles,стили>>. Стили задаются в XML-дексрипторе или контроллере экрана:
[source, xml]
----

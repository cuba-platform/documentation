...
* <<cuba.gui.genericFilterColumnsQty,cuba.gui.genericFilterColumnsQty>> - задает количество колонок по умолчанию для размещения условий фильтра. См также атрибут фильтра <<gui_Filter_columnsQty,columnsQty>>.

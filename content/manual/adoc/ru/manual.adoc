...
:fts_man_url: http://docs.haulmont.com/cuba/{revnumber}/fts/ru/html-single/fts.html
...
Обучающие видео-материалы и презентации располагаются по адресу link:https://www.cuba-platform.ru/tutorials[www.cuba-platform.ru/tutorials].

Онлайн демо-приложения могут быть запущены со страницы link:https://www.cuba-platform.ru/online-demo[www.cuba-platform.ru/online-demo].

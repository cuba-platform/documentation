...
// TODO we may want to change frontend_manual_url from GitHub Pages to a site under cuba-platform.com
:frontend_manual_url: https://cuba-platform.github.io/frontend/
:git_branch: master

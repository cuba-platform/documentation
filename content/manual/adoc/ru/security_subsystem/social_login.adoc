...
[TIP]
====
Смотрите также руководство https://www.cuba-platform.com/guides/anonymous-access-and-social-login[Anonymous Access and Social Login].

В руководстве приведен пример настройки открытого доступа к CUBA-приложению, а также реализации пользовательского входа в приложение с помощью учетной записи Google, Facebook или GitHub.
====

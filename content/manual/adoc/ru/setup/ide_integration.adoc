...
[TIP]
====
Если вы используете https://www.cuba-platform.com/marketplace/cuba-cli[CUBA CLI], перейдите в каталог проекта в используемом терминале и выполните команду `gradlew idea`, чтобы создать необходимые файлы для интеграции с IntelliJ IDEA.
====
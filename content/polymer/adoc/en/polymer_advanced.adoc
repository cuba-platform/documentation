...
In this case `this.$.square` won't work even if the condition is true. More info in the https://www.polymer-project.org/2.0/docs/devguide/dom-template#node-finding[official guide].

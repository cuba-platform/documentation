...
In this case `this.$.square` won't work even if the condition is true. More info in https://www.polymer-project.org/2.0/docs/devguide/dom-template#node-finding[official guide]
...
* `this.shadowRoot.querySelector("{selector}")` can be used to find an element by CSS selector.

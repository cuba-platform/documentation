...
Another interesting detail is how to change properties correctly. There are special Polymer methods to mutate properties. If you don't use them and change properties as you change local variables (using "=" operator) then UI won't be updated

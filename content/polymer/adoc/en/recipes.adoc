...
[TIP]
====
If you bundle your client code before production (and CUBA Studio does it by default),
the problem is entirely in the area of development environment. Production and test code has no import statements

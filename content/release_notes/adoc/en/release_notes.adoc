...
The `Embedded` component has been deprecated. Use the {manual}/gui_Image.html[Image] component for displaying images or the {manual}/gui_BrowserFrame.html[BrowserFrame] component for embedded web pages.

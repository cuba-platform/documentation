...
. A user password is required even if you use <<ldap_basic,LDAP>> authentication. You can disable this using <<cuba.web.requirePasswordForNewUsers, cuba.web.requirePasswordForNewUsers>> application property.

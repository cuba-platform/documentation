...
[WARNING]
====
Please note that in order to work with CUBA 7.2, you need to install Studio 13 BETA3 or newer. Older versions of Studio don't have correct support for project creation, migration and hot deployment.

...
* Logout button shown on the main screen has been replaced with the `UserActionsButton` component. If the user is not authenticated, the component allows the user to go to login screen; when authenticated, the component provides actions to show the *Settings* screen or to log out.

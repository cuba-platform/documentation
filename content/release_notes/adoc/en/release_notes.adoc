...
. `DataContext.PostCommitEvent` is now sent *after* merging of committed entities back to the screen's data context, see the https://github.com/cuba-platform/cuba/issues/1981[corresponding issue].

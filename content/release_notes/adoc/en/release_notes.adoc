...
* {githubissueslog}/release_6.9.12.md[Platform 6.9.12 Resolved Issues - GitHub]

* {githubissueslog}/release_6.9.11.md[Platform 6.9.11 Resolved Issues - GitHub]

* {githubissueslog}/release_6.9.10.md[Platform 6.9.10 Resolved Issues - GitHub]

* {githubissueslog}/release_6.9.9.md[Platform 6.9.9 Resolved Issues - GitHub]

* {githubissueslog}/release_6.9.8.md[Platform 6.9.8 Resolved Issues - GitHub]

* {githubissueslog}/release_6.9.7.md[Platform 6.9.7 Resolved Issues - GitHub]

* {githubissueslog}/release_6.9.6.md[Platform 6.9.6 Resolved Issues - GitHub]

* {githubissueslog}/release_6.9.5.md[Platform 6.9.5 Resolved Issues - GitHub]
...
* https://youtrack.cuba-platform.com/issues/STUDIO?q=State:%20Fixed,%20Verified%20Fix%20versions:%206.9.5%20Affected%20versions:%20-SNAPSHOT%20sort%20by:%20created%20asc[Studio 6.9.5 Resolved Issues]
* https://youtrack.cuba-platform.com/issues/STUDIO?q=State:%20Fixed,%20Verified%20Fix%20versions:%206.9.4%20Affected%20versions:%20-SNAPSHOT%20sort%20by:%20created%20asc[Studio 6.9.4 Resolved Issues]

...
. Java 8, 9 and 10 can be used to build and run applications. If you are using Java 10, add the following dependencies to the `global` module in `build.gradle`:
+
[source, groovy]
----

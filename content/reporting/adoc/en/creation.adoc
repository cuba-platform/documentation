...
+
For JPQL queries the <<data_store,datastore>> should be set, the default is `Main`. To use the entities from an additional datastore, put its name in the *Data store* field:

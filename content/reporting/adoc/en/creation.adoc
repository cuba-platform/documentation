...
To control page size, page headers and footers, use special CSS rules and properties. You can find an example of a report with repeatable header and footer blocks on https://github.com/cuba-labs/reports-pdf-page-settings[CUBA GitHub].

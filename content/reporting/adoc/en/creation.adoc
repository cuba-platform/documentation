...
, thus enabling you to write queries in SQL/JPQL instead of Groovy directly.
--
...
You can also activate <<sql_preprocessing,JPQL preprocessing>> by checking the *Preprocess SQL as Groovy template* checkbox below the band editor.

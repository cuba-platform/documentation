...
Table output is available for all types of reports. Resulting table is displayed in the *Reports > Show Report Table* screen of your web application.

The report generator will get BandData and draw a sortable table for each band from 1st level of the hierarchy.

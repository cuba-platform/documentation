...
The pivot table displays all properties for all types of <<structure,datasets>>. These properties should be set as the pivot table's properties on the *Properties options* tab of the template editor:

...
First of all, open the *Project Properties* editor in CUBA Studio: click *CUBA* → *Project Properties* main menu item. Add the *reports* application component in the *App components* list.

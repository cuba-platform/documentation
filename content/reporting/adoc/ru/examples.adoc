...
. `<band_name>`*_dynamic_header* - заполняет отчёт значениями слева вправо, как вертикальная полоса с заголовками столбцов матрицы,

. `<band_name>`*_master_data* - заполняет отчёт значениями сверху внизу, как горизонтальная полоса с заголовками строк матрицы,

. пустой набор данных для заполнения ячеек матрицы.

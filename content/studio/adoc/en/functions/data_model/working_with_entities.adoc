...
+
image::functions/data_model/new_entity.png[align="center"]

. Enter the name of the entity class in the *Entity name* field.
+
image::functions/data_model/new_entity_2.png[align="center"]
...
+
image::functions/data_model/new_attribute.png[align="center"]
+
...
+
image::functions/data_model/new_attribute_2.png[align="center"]
--
...
image::functions/data_model/create_name_pattern.png[align="center"]
--
...
+
image::functions/data_model/create_message.png[align="center"]
--

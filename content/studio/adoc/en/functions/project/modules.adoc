...
Studio lets you easily create, edit and remove modules: *core*, *gui*, *portal*, *web*, and *web-toolkit* from CUBA menu (CUBA > Advanced > Manage Modules) or from the *Modules* section of the *Project* view.
